...
export const products: Product[] = [
 ...
 /*  {
  ...
  {   
    ...
    price: 450,
    image: 'https://m.media-amazon.com/images/I/41XYo-TZRFL._UF1000,1000_QL80_.jpg?auto=compress&cs=tinysrgb&w=400',
    category: 'Snacks',
    description: 'Aromatic coffee beans - 500g',
    inStock: true,
    featured: true,
  ...
  //kitchen
   ...
   {   
    ...
    name: 'Samrat Maida ',
    price: 450,
    image: 'https://m.media-amazon.com/images/I/71ti2SgDXOL.jpg?auto=compress&cs=tinysrgb&w=400',
    category: 'Kitchen',
    description: 'Aromatic coffee beans - 500g',
    inStock: true,
    featured: true,
 ...
 /*  {   
   ...
   {   
    ...
    name: 'Taj Mahal',
    price: 450,
    image: 'https://www.swadesh.eu/wp-content/uploads/2022/04/Taj-_Tea_250gms_new-242x300.jpg?auto=compress&cs=tinysrgb&w=400',
    category: 'Tea&Coffee',
    description: 'Aromatic coffee beans - 500g',
    inStock: true,
    featured: true,
   ...
   {   
    ...
    name: 'Vikram Dust',
    price: 450,
    image: 'https://www.vikramtea.com/cdn/shop/files/26_Kadakdustfront.jpg?v=1744893978?auto=compress&cs=tinysrgb&w=400',
    category: 'Tea&Coffee',
    description: 'Aromatic coffee beans - 500g',
    inStock: true,
    featured: true,
   ...
   {   
    ...
    name: 'BournVita',
    price: 450,
    image: 'https://m.media-amazon.com/images/I/51DJqbwK+kL._UF1000,1000_QL80_.jpg?auto=compress&cs=tinysrgb&w=400',
    category: 'Tea&Coffee',
    description: 'Aromatic coffee beans - 500g',
    inStock: true,
    featured: true,
